    ...
    <b-row>
        ...
        <b-card>
          <div class="d-md-flex justify-content-between align-items-center my-1">
            <div class="border-left-primary border-left-3">
              <p class="card-title p-50 mb-0">Swap</p>
            </div>
            <div>
            <b-row>
      <b-col cols="12" md="12" class="marbalign">
        <div class="d-flex align-items-center justify-content-end">
          ...
          >
            <span class="text-nowrap">Apply Swap</span>
          </b-button>
        </div>
      </b-col>
    </b-row>
...
export default {
  ...
  data() {
    return {
      ...
      hod: "",
      option: [""],
      fields: [{key: "name", sortable: true},{key: "request_date", sortable: true},{key: "mode", sortable: true},{key: "approver_name", sortable: true},{key: "status", sortable: true}],
      EditId: 0,
      CheckInButton:false,
