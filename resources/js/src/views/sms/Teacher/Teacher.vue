        ...
        <b-card>
          <div class="d-md-flex justify-content-between align-items-center my-1">
            <div class="border-left-primary border-left-3">
              <p class="card-title p-50 mb-0">Teacher</p>
            </div>
            <div>
            <b-row>
        ...
        >
            <template #cell(student_id)="data">
              <div class="text-nowrap">
                <span
                  ...
                  :title="data.item.roll_number"
                  >{{ data.item.roll_number }}</span
                >
              </div>
            </template>
            <template #cell(first_name)="data">
              ...
              <div class="text-nowrap">
                <span
                  class="align-text-top text-capitalize"
                  :title="data.item.class"
                  >{{ data.item.class }}</span
                >
              </div>
            </template>
              ...
              <div class="text-nowrap">
                <span
                  class="align-text-top text-capitalize"
                  :title="data.item.section"
                  >{{ data.item.section }}</span
                >
              </div>
            </template>
              ...
              <div class="text-nowrap">
                <span
                  class="align-text-top text-capitalize"
                  :title="data.item.parent_number"
                  >{{ data.item.parent_number }}</span
                >
              </div>
            </template>
             <template #cell(action)="data">
              ...
              <b-link
                :to="{ name: 'view-student', params: { id: data.item.user_id } }"
                title="View"
                >
...
export default {
  ...
  data() {
    return {
      ...
      hod: "",
      option: [""],
      fields: [{key: "employee_id", sortable: true},{key: "first_name", sortable: true},"middle_name","last_name",'action'],
      EditId: 0,
      CheckInButton:false,
  ...
  setup(props, { emit }) {
    ...
    const FetchStudentData = (ctx, callback) => {
     axios.get('teachers', {
                 params: {
                    ...SearchFilter.value,
