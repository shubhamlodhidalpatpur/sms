  ...
  methods: {
    ...
    SectionOnshown: function SectionOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getClass").then(function (response) {
        _this4.ClassOptionsData = response.data["class"];
      });
      ...
      if (this.EditSectionId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("class/".concat(this.EditSectionId, "/edit")).then(function (response) {
          _this4.SectionData.name = response.data.data.name;
          _this4.SectionData.id = response.data.data.id;
          _this4.SectionData["class"] = response.data.data.parent_id;
        });
      } else {
