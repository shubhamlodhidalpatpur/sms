      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("CheckinAttendance").then(function (response) {
        ...
        _this.$toast({
          ...
          props: {
            ...
            icon: 'CheckIcon',
            variant: 'success' // text: `You have successfully logged in as ${userData.role}. Now you can start to explore!`,
    ...
    BUShowon: function BUShowon() {
      ...
      if (this.EditId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("BU/edit/".concat(this.EditId)).then(function (response) {
          ...
          _this3.BUData.name = response.data.data.title;
          _this3.BUData.id = response.data.data.id;
        });
      } else {
        this.BUData.name = "";
