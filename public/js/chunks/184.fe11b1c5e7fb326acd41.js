...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onChange: function onChange(element, value) {
      ...
      if (element == "department") {
        ...
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/getRoleFromdepartmentId/".concat(value)).then(function (response) {
          _this.ReportigRoleOptions = response.data.data;
        });
      }

      if (element == "departmentforTeam") {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/teamoption/".concat(value)).then(function (response) {
    ...
    deleteRole: function deleteRole() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"]["delete"]("role/".concat(this.DeleteId)).then(function (response) {
        _this2.refetchData();
    ...
    Onshown: function Onshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/getDepartment").then(function (response) {
        _this3.departmentData = response.data.data;
      });

      if (this.RoleEdit != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/roleEdit/".concat(this.RoleEdit)).then(function (response) {
          _this3.Roledata.name = response.data.data.name;
          _this3.Roledata.department = response.data.data.department_id;
          _this3.Roledata.reporting_role = response.data.data.reporting_role;
          _this3.Roledata.team = response.data.data.team;
          _this3.Roledata.id = response.data.data.id;
          _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/getRoleFromdepartmentId/".concat((_this3.Roledata.reporting_role, _this3.Roledata.department))).then(function (response) {
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("/getDepartment").then(function (response) {
      _this4.departmentData = response.data.data;
    }); //    axios.get('getRole').then(response => {
    // this.ReportigRoleOptions = response.data.data
    // })
    // axios.get("/teamoption").then((response) => {
  ...
  setup: function setup(props, _ref) {
    ...
    var submitRole = function submitRole() {
      if (Roledata.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("/RoleUpdate/".concat(Roledata.value.id), Roledata.value).then(function (response) {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("/roleadd", Roledata.value).then(function (response) {
          refetchData();
    ...
    var fecthRole = function fecthRole(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('fecthRole', {
    ...
    var Searchdata = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(JSON.parse(JSON.stringify({
    ...
    var showRoleModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(false);
    ...
    var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(5);
    var perPageOptions = [5, 10, 100];
    var currentPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(1);
    var Roledata = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(JSON.parse(JSON.stringify(BlankProjectData)));
    var refProjectListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])(null);
    ...
    var totalProject = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["ref"])();
