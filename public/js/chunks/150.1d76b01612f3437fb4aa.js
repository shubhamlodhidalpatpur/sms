                          ...
                          return [
                            _c(
                              "b-form-checkbox",
                              {
                                staticClass: "vs-checkbox-con",
                                attrs: { plain: "" },
                                on: { change: _vm.row.toggleDetails },
                                model: {
                                  value: _vm.row.detailsShowing,
                                  callback: function ($$v) {
                                    _vm.$set(_vm.row, "detailsShowing", $$v)
                                  },
                                  expression: "row.detailsShowing",
                                },
                              },
                              [
                                ...
                                _c("span", { staticClass: "vs-label" }, [
                                  _vm._v(
                                    _vm._s(
                                      _vm.row.detailsShowing ? "Hide" : "Show"
                                    )
                                  ),
                                ]),
                              ]
