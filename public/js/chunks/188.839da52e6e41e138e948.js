...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_0__["default"].get('getClassSectionMaster').then(function (response) {
                    ...
                    [
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("div", { staticClass: "inneroneliner descName" }, [
                            _c(
                              "div",
                              {
                                staticClass: "distributed inlineBox",
                                staticStyle: { "margin-right": "80px" },
                              },
                              [
                                _c("feather-icon", {
                                  staticClass: "mr-50",
                                  attrs: { size: "15", icon: "UserIcon" },
                                }),
                                _vm._v(
                                  "\n                " +
                                    _vm._s(okr.goal_for_entity) +
                                    "\n              "
                                ),
                              ],
                              1
                            ...
                            _c(
                              ...
                              [
                                ...
                                _c("b-progress", {
                                  attrs: {
                                    variant: okr.progress_status,
                                    value: okr.progress_percentage,
                                    max: "100",
                                  },
                                }),
                                _vm._v(" "),
                                _c("span", [
                                  _vm._v(
                                    " Progress:" +
                                      _vm._s(okr.progress_percentage) +
                                      "%"
                                  ),
                                ]),
                              ],
                            ...
                            _vm._v(" "),
                            _c("div", { staticClass: "distributed" }, [
                              _vm._v(
                                "\n                " +
                                  _vm._s(okr.start_date) +
                                  "\n              "
                              ),
                            ]),
                            _vm._v(" "),
