                        ...
                        fn: function (data) {
                          return [
                            _c("v-select", {
                              ...
                              model: {
                                value: data.value.subject_id,
                                callback: function ($$v) {
                                  _vm.$set(data.value, "subject_id", $$v)
                                },
                                expression: "data.value.subject_id",
                              },
                            }),
                          ]
                        },
                        ...
                        fn: function (data) {
                          return [
                            _c("v-select", {
                              ...
                              model: {
                                value: data.value.subject_teacher_id,
                                callback: function ($$v) {
                                  _vm.$set(
                                    data.value,
                                    "subject_teacher_id",
                                ...
                                expression: "data.value.subject_teacher_id",
                              },
                            }),
                          ]
                        },
