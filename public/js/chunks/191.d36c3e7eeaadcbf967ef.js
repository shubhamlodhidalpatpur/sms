...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/user/userStoreModule.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserInfoCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserPlanCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserTimelineCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserPermissionsCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/project/useProjectList'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/Bizinso/CardStatisticsGroup.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @axios */ "./resources/js/src/libs/axios.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/apps/task/TaskList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/dashboard/TaskStatusDashboard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BProgressBar: bootstrap_vue__WEBPACK_IMPORTED_MODULE_3__["BProgressBar"],
    BProgress: bootstrap_vue__WEBPACK_IMPORTED_MODULE_3__["BProgress"],
    UserViewUserPlanCard: !(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserPlanCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    UserViewUserTimelineCard: !(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserTimelineCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    UserViewUserPermissionsCard: !(function webpackMissingModule() { var e = new Error("Cannot find module '../user/users-view/UserViewUserPermissionsCard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    CardStatisticsGroup: !(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/Bizinso/CardStatisticsGroup.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    task: !(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/apps/task/TaskList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    VBPopover: bootstrap_vue__WEBPACK_IMPORTED_MODULE_3__["VBPopover"],
    ...
    TaskStatusDashboard: !(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/dashboard/TaskStatusDashboard.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  directives: {
    Ripple: vue_ripple_directive__WEBPACK_IMPORTED_MODULE_6__["default"],
    'b-popover': bootstrap_vue__WEBPACK_IMPORTED_MODULE_3__["VBPopover"],
  ...
  methods: {
    ...
    getProgressBarColor: function getProgressBarColor(userTaskCount, totalTaskCount) {
      var percentage = userTaskCount / totalTaskCount * 100;

      if (percentage <= 20) {
        return 'danger'; // Red color for 0-20%
      } else if (percentage <= 40) {
        return 'primary'; // Blue color for 11-40%
      } else {
        return 'success'; // Green color for 41% and above
      }
    }
  }
});
