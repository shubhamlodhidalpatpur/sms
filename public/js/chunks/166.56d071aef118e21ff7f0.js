    ...
    Onshown: function Onshown() {
      ...
      if (this.EditdepartmentId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("departmentedit/".concat(this.EditdepartmentId)).then(function (response) {
          ...
          _this3.departmentData.id = response.data.data.id; // this.departmentData.reporting_manager = response.data.data.reporting_manage

          _this3.departmentData.BU = response.data.data.bu_id; // this.departmentData.department_members = response.data.data.department_members
        });
      } else {
        this.departmentData.department_name = '';
        this.departmentData.id = null; // this.departmentData.reporting_manager = ''

        this.departmentData.BU = ''; // this.departmentData.department_members = ''
      }
    },
          ...
          _c(
            ...
            [
              ...
              _c("v-select", {
                ...
                model: {
                  value: _vm.departmentData.BU,
                  callback: function ($$v) {
                    _vm.$set(_vm.departmentData, "BU", $$v)
                  },
                  expression: "departmentData.BU",
                },
              }),
              _vm._v(" "),
