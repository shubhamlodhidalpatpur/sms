...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteholiday: function deleteholiday() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"]("holiday/".concat(this.DeleteId)).then(function (response) {
        _this2.refetchData();
    ...
    Onshown: function Onshown() {
      ...
      console.log("this.EditholidayId", this.EditholidayId, this.holidayData);

      if (this.EditholidayId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("holidayedit/".concat(this.EditholidayId)).then(function (response) {
          _this3.holidayData.holiday_name = response.data.data.title;
          _this3.holidayData.id = response.data.data.id;
          _this3.holidayData.branch = response.data.data.branch_id;
        });
      } else {
        this.holidayData.holiday_name = '';
        this.holidayData.id = null;
        this.holidayData.branch = '';
      }
    },
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchholiday = function fetchholiday(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('fetchholiday', {
    ...
    var submitholiday = function submitholiday() {
      ...
      if (holidayData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("holidayUpdate/".concat(holidayData.value.id), holidayData.value).then(function () {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post('addholiday', holidayData.value).then(function () {
          refetchData();
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        "b-form-group",
                                        {
                                          staticClass: "BranchFilterholiday",
                                          attrs: {
                                            label: "Branch",
                                            "label-for": "Branch",
                                          },
          ...
          _c(
            ...
            [
              ...
              _c("v-select", {
                ...
                model: {
                  value: _vm.holidayData.branch,
                  callback: function ($$v) {
                    _vm.$set(_vm.holidayData, "branch", $$v)
                  },
                  expression: "holidayData.branch",
                },
              }),
              _vm._v(" "),
