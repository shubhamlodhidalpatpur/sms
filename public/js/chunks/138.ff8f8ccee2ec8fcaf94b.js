...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteBU: function deleteBU() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"]("Subject/".concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
    ...
    BUShowon: function BUShowon() {
      ...
      if (this.EditId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("Subject/".concat(this.EditId, "/edit")).then(function (response) {
          _this2.SubjectData.name = response.data.data.name;
  ...
  setup: function setup(props, _ref) {
    ...
    var handleSubmit = function handleSubmit() {
      if (SubjectData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].put("Subject/".concat(SubjectData.value.id), SubjectData.value).then(function (response) {
          refetchData();
