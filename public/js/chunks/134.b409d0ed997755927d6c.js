  ...
  methods: {
    ...
    AssignTeacherOnshown: function AssignTeacherOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getSubjectsWithTeacher/".concat(this.AssignClassId)).then(function (response) {
        _this4.AssignTeacherData.SubjctTeacherData[0].subject_id = response.data.data[0];
        var newDataArray = response.data.data.map(function (data) {
          return {
            subject_id: data.subject_id,
            subject_teacher_id: data.subject_teacher_id // Assuming this variable exists

          };
        }); // Check if newDataArray has elements before pushing
        ...
        [
          _c(
            ...
            [
              ...
              _vm._v(
                "\n        " +
                  _vm._s(_vm.AssignTeacherData.SubjctTeacherData) +
                  "\n        "
              ),
              _vm._l(_vm.AssignTeacherData.SubjctTeacherData, function (data) {
                return _c(
                  "div",
                  { key: data },
                  [
