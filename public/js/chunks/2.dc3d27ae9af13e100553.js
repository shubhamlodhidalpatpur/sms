...
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @axios */ "./resources/js/src/libs/axios.js");
...
/* harmony import */ var _core_utils_utils__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @core/utils/utils */ "./resources/js/src/@core/utils/utils.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    EditIcon: vue_feather_icons__WEBPACK_IMPORTED_MODULE_17__["EditIcon"],
  ...
  methods: {
    ...
    deleteleaveType: function deleteleaveType() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_13__["default"]["delete"]("deleteModule/".concat(this.$route.name, "/").concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
  ...
  setup: function setup(props, _ref) {
    ...
    var _useRouter = Object(_core_utils_utils__WEBPACK_IMPORTED_MODULE_18__["useRouter"])(),
        route = _useRouter.route,
        router = _useRouter.router;

    var fields = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])([]);
    var toast = Object(vue_toastification_composition__WEBPACK_IMPORTED_MODULE_15__["useToast"])();
    var _ref2 = [Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(null), Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(false)],
        sortBy = _ref2[0],
    ...
    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      var filterData = {
        ...
        // Assuming FilterFields is an array or object containing filter data
      ...
      var url = new URL("getModuleData/".concat(route.value.name));
      Object.keys(filterData).forEach(function (key) {
        return url.searchParams.append(key, filterData[key]);
    ...
    var totalBUs = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(0);
    ...
    var FetchTableFilds = function FetchTableFilds() {
      _axios__WEBPACK_IMPORTED_MODULE_13__["default"].get("getListingFields/".concat(route.value.name)).then(function (response) {
        fields.value = response.data.data;
      });
    };

    var FilterFields = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])([]);

    var fethFilterFields = function fethFilterFields() {
      _axios__WEBPACK_IMPORTED_MODULE_13__["default"].get("getFields/".concat(route.value.name), {
        params: {
          filter: true
        }
    ...
    var BUListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(null);
    ...
    var SearchFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(JSON.parse(JSON.stringify({
      FilterData: FilterData
    })));

    var ResetFilter = function ResetFilter() {
      employeeFilterData.value = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(JSON.parse(JSON.stringify({
        FilterData: FilterData
      })));
      refetchData();
    };

    var currentPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(1);
    var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(10);
    ...
    var showBUModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["ref"])(false);
    var dataMeta = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["computed"])(function () {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_14__["watch"])([currentPage, perPage, route], function () {
      FetchTableFilds();
      refetchData();
    });
    return {
