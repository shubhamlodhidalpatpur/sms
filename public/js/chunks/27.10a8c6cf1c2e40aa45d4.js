...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getListingFields/".concat(this.$route.name)).then(function (response) {
  ...
  setup: function setup(props, _ref) {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_8__["watch"])([currentPage, perPage, route.name], function () {
      refetchData();
    });
    return {
      hasErrors: hasErrors,
