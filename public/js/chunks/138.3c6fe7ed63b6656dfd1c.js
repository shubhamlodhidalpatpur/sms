...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteleaveType: function deleteleaveType() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"]("LeaveTypes/".concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("getFields/".concat(this.$route.name)).then(function (response) {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("CHeckTodayAttendance").then(function (response) {
      ...
      if (response.data.data.checkin_time) {
        _this2.CheckInButton = true;
        _this2.CheckOutButton = false;
      }
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('LeaveTypes', {
