...
/* harmony default export */ __webpack_exports__["default"] = (_components$directive = {
  ...
  var onChange = function onChange(element, value) {
    ...
    if (element == "branch") {
      ...
      var _useRouter = Object(_core_utils_utils__WEBPACK_IMPORTED_MODULE_9__["useRouter"])(),
          _route = _useRouter.route,
          _router = _useRouter.router;
  ...
  var fetchModuleForm = function fetchModuleForm() {
    _axios__WEBPACK_IMPORTED_MODULE_10__["default"].get("getFieldsByRole/".concat(route.value.params.module_name)).then(function (response) {
                                ...
                                ? _c("v-select", {
                                    ...
                                    on: {
                                      input: function ($event) {
                                        return _vm.fetchModuleForm($event)
                                      },
                                    },
                                    model: {
