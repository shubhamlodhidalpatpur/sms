...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BProgressBar: bootstrap_vue__WEBPACK_IMPORTED_MODULE_6__["BProgressBar"],
    ...
    BTfoot: bootstrap_vue__WEBPACK_IMPORTED_MODULE_6__["BTfoot"]
  },
  directives: {
    Ripple: vue_ripple_directive__WEBPACK_IMPORTED_MODULE_8__["default"],
    "b-popover": bootstrap_vue__WEBPACK_IMPORTED_MODULE_6__["VBPopover"],
  ...
  methods: (_methods = {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("updateClassLacture", this.lectureSchedule).then(function (response) {
      _this.$toast({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getLectureData/".concat(this.$route.params.id)).then(function (response) {
      _this2.lectureSchedule.LectureItems = response.data.data.lecture_data;
      var newDataArray = response.data.data.map(function (data) {
        return {
          startTime: data.subject_id,
          endTime: data.subject_teacher_id
        };
      });

      if (newDataArray.length > 0) {
        _this2.AssignTeacherData.SubjctTeacherData = newDataArray;
      }
    });
  },
  setup: function setup(props, _ref) {
    ...
    var lectureSchedule = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(JSON.parse(JSON.stringify(blanklectureSchedule)));
    return {
