...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('').then(function (response) {
  ...
  methods: {
    ...
    Onshown: function Onshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('repotingManager').then(function (response) {
        // this.repotingManager = response.data.employee
        _this3.DepartmentData = response.data.department; // this.branchMemberData=response.data.branchMember
      });
