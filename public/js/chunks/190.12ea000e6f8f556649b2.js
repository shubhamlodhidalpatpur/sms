...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    AssignTeacherOnshown: function AssignTeacherOnshown() {
      var _this4 = this;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getClassTeacher/".concat(this.AssignClassId)).then(function (response) {
        _this4.AssignTeacherData.class_teacher = response.data.class_teacher;
      });
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getSubjectsWithTeacher/".concat(this.AssignClassId)).then(function (response) {
        var newDataArray = response.data.data.map(function (data) {
          return {
        ...
        if (newDataArray.length > 0) {
          _this4.AssignTeacherData.SubjctTeacherData = newDataArray;
        }
      });
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("users").then(function (response) {
        _this4.TeacherData = response.data.table_data;
      });
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getSubject").then(function (response) {
        _this4.SubjectData = response.data.data;
      });
    },
    SectionOnshown: function SectionOnshown() {
      var _this5 = this;
    ...
    resetSectionModal: function resetSectionModal() {
      this.ShowSectionModel = false;
      this.errors = [];
    },
    resetAssignSubjectModel: function resetAssignSubjectModel() {
      this.showAssignSubjectModel = false;
    },
    resetAssignTeacherModel: function resetAssignTeacherModel() {
  ...
  setup: function setup(props, _ref) {
    ...
    var SubmitAssignTeacher = function SubmitAssignTeacher() {
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("AssignTeacher", AssignTeacherData.value).then(function () {
        refetchData();
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c("v-select", {
                            ...
                            model: {
                              value: _vm.AssignTeacherData.class_teacher,
                              callback: function ($$v) {
                                _vm.$set(
                              ...
                              expression: "AssignTeacherData.class_teacher",
                            },
                          }),
                          _vm._v(" "),
                          _c("small", { staticClass: "text-danger" }, [
                ...
                [
                  _c("b-table", {
                    attrs: {
                      responsive: "",
                      striped: "",
                      items: _vm.AssignTeacherData.SubjctTeacherData,
                      fields: _vm.AssignTeacherTableFields,
                    },
                    scopedSlots: _vm._u([
                      {
                        key: "cell(subject)",
                        fn: function (data) {
                          return [
                            _c("v-select", {
                              ...
                              model: {
                                value: data.item.subject_id,
                                callback: function ($$v) {
                                  _vm.$set(data.item, "subject_id", $$v)
                                },
                                expression: "data.item.subject_id",
                              },
                            }),
                          ]
                        },
                        ...
                        fn: function (data) {
                          return [
                            _c("v-select", {
                              ...
                              model: {
                                value: data.item.subject_teacher_id,
                                callback: function ($$v) {
                                  _vm.$set(data.item, "subject_teacher_id", $$v)
                                },
                                expression: "data.item.subject_teacher_id",
                              },
                            }),
                          ]
                        },
