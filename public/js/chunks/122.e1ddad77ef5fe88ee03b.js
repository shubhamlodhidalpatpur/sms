...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    editteam: function editteam(id) {
      ...
      this.teamData.id = id;
      this.EditteamId = id;
      console.log("editteam", id, this.teamData, this.EditteamId);
    ...
    Onshown: function Onshown() {
      ...
      if (this.EditteamId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("teamedit/".concat(this.EditteamId)).then(function (response) {
          ...
          _this3.teamData.branch = response.data.data.branch_id;
        });
      } else {
        this.teamData.team_name = '';
        this.teamData.id = null;
        this.teamData.branch = '';
      }
    },
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c("v-select", {
                                            ...
                                            model: {
                                              value: _vm.teamFilterData.branch,
                                              callback: function ($$v) {
                                                _vm.$set(
                                                  _vm.teamFilterData,
                                                  "branch",
          ...
          _c(
            ...
            [
              ...
              _c("v-select", {
                ...
                model: {
                  value: _vm.teamData.branch,
                  callback: function ($$v) {
                    _vm.$set(_vm.teamData, "branch", $$v)
                  },
                  expression: "teamData.branch",
                },
              }),
              _vm._v(" "),
