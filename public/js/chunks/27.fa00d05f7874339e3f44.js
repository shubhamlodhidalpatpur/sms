...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("getFields/".concat(this.$route.name)).then(function (response) {// this.fields=response.data.data;
    });
  },
  setup: function setup(props, _ref) {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_7__["watch"])([currentPage, perPage, route.value.name], function () {
      refetchData();
    });
    return {
      hasErrors: hasErrors,
