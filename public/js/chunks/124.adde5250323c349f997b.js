  ...
  setup: function setup(props, _ref) {
    ...
    var statusChange = function statusChange(id, status) {
      ...
      if (confirm(text) == true) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("changeStatus/".concat(id, "/").concat(status)).then(function (response) {
          refetchData();
    ...
    var fetchAttendance = function fetchAttendance(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('CheckAttendances', {
