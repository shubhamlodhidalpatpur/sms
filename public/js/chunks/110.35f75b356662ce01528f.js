      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_9__["default"].login({
            ...
            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_13__["getHomeRouteForLoggedInUser"])('admin')).then(function () {
              _this.$toast({
                component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_14__["default"],
                position: "top-right",
                props: {
                  title: "Welcome ".concat(userData.name || 'admin'),
                  icon: "CoffeeIcon",
                  variant: "success"
                }
              });
