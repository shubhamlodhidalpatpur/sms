                        ...
                        [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _vm.$can("do", "add_key_result") &&
                              _vm.row.goal_type_slug != null &&
                              (_vm.row.goal_type_slug.toLowerCase() ==
                                "objective" ||
                                _vm.row.goal_type_slug.toLowerCase() ==
                                  "milestone")
                                ? _c(
                                      ...
                                      directives: [
                                        {
                                          name: "b-toggle",
                                          rawName:
                                            "v-b-toggle.add-key-result-drawer",
                                          modifiers: {
                                            "add-key-result-drawer": true,
                                          },
                                        },
                                      ],
                                      staticClass:
                                        "badge smallFont badge-primary",
                                      class: {
                                        disabledBox:
                                          _vm.row.totalweightage == 100 ||
                                          _vm.row.progress ==
                                            _vm.row.target_to ||
                                          _vm.row.request_id != null,
                                      },
                                      attrs: { href: "#", title: "Key Result" },
                                      on: {
