...
/* harmony import */ var _branch_Branch_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../branch/Branch.vue */ "./resources/js/src/views/sms/branch/Branch.vue");
/* harmony import */ var _BU_BU_vue__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../BU/BU.vue */ "./resources/js/src/views/sms/BU/BU.vue");
/* harmony import */ var _team_Team_vue__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../team/Team.vue */ "./resources/js/src/views/sms/team/Team.vue");
/* harmony import */ var _role_Role_vue__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../role/Role.vue */ "./resources/js/src/views/sms/role/Role.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    role: _role_Role_vue__WEBPACK_IMPORTED_MODULE_23__["default"],
    team: _team_Team_vue__WEBPACK_IMPORTED_MODULE_22__["default"],
    department: _department_Department_vue__WEBPACK_IMPORTED_MODULE_19__["default"],
    bu: _BU_BU_vue__WEBPACK_IMPORTED_MODULE_21__["default"],
    branch: _branch_Branch_vue__WEBPACK_IMPORTED_MODULE_20__["default"],
  ...
  methods: {
    ...
    formSubmitted: function formSubmitted() {
      ...
      this.$router.replace('/home').then(function () {
        _this2.$toast({
      ...
      _c(
        ...
        [
          ...
          _c(
            "tab-content",
            {
              attrs: { title: "BU", "before-change": _vm.validationForm },
              on: {
                change: function ($event) {
          ...
          _c(
            "tab-content",
            {
              attrs: { title: "Branch", "before-change": _vm.validationForm },
              on: {
                change: function ($event) {
                  _vm.activeTab = "BranchForm"
                },
              },
            },
            [
              _c(
                "validation-observer",
                { ref: "BranchForm", attrs: { tag: "form" } },
                [
                  _vm.hasErrors("BlankBranch")
                    ? _c("div", { staticClass: "text-danger" }, [
                        _vm._v(
                          "\n            " +
                            _vm._s(_vm.getErrors("BlankBranch")) +
                            "\n          "
                        ),
                      ])
                    : _vm._e(),
                  ...
                  _c("branch", {
                    on: {
                      removeBlankDepartmentError: function ($event) {
                        return _vm.RemoveError("BlankBranch")
                      },
                    },
                  }),
                ],
