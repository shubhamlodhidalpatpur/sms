...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addField: function addField(index) {
      ...
      this.Roledata.masterFields.splice(index + 1, 0, data);
    },
    removeField: function removeField(index) {
      this.Roledata.masterFields.splice(index, 1);
    },
    ...
    Onshown: function Onshown() {
      ...
      if (this.RoleEdit != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/roleEdit/".concat(this.RoleEdit)).then(function (response) {
          _this3.Roledata.name = response.data.data.name;
          _this3.Roledata.department = response.data.data.department_id;
          _this3.Roledata.reporting_role = response.data.data.parent_id;
          _this3.Roledata.team = response.data.data.team;
          _this3.Roledata.id = response.data.data.id;
          _this3.Roledata.masterFields = response.data.data.masterFields;
          _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/getRoleFromdepartmentId/".concat((_this3.Roledata.reporting_role, _this3.Roledata.department))).then(function (response) {
            _this3.ReportigRoleOptions = response.data.data;
          });
        });
      } else {
        this.resetRoledata();
  ...
  setup: function setup(props, _ref) {
    ...
    var submitRole = function submitRole() {
      if (Roledata.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("/RoleUpdate/".concat(Roledata.value.id), Roledata.value).then(function (response) {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("/roleadd", Roledata.value).then(function (response) {
          refetchData();
    ...
    var fetchRole = function fetchRole(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('fetchRole', {
    ...
    var Roledata = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(JSON.parse(JSON.stringify(BlankProjectData)));
    ...
    _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('getFieldsByRole').then(function (response) {
      BlankProjectData.masterFields = response.data.data;
      Roledata.value.masterFields = response.data.data;
    });

    var resetRoledata = function resetRoledata() {
      Roledata.value = JSON.parse(JSON.stringify(BlankProjectData));
    };
                ...
                [
                  ...
                  _c("b-table", {
                    ...
                    scopedSlots: _vm._u([
                      ...
                      {
                        key: "cell(Reporting_Role)",
                        fn: function (data) {
                          return [
                            _c("span", { staticClass: "text-nowrap" }, [
                              _vm._v(
                                "\n              " +
                                  _vm._s(data.item.rol) +
                                  "\n            "
                              ),
                            ]),
                          ]
      ...
      _c(
        "b-modal",
        {
          attrs: {
            ...
            title: _vm.RoleEdit ? "Update Role" : "Add Role",
            "ok-title": _vm.RoleEdit ? "Update" : "Add",
            centered: "",
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  ...
                  _c("v-select", {
                    ...
                    on: {
                      input: function ($event) {
                        _vm.onChange("department", $event)
                        _vm.RemoveError("department")
                      },
                    },
                    model: {
              ...
              _c(
                ...
                [
                  _c("label", { staticClass: "form-label required" }, [
                    _vm._v("Reporting Role"),
                  ]),
                  _vm._v(" "),
                  _c("v-select", {
                    attrs: {
                      dir: _vm.$store.state.appConfig.isRTL ? "rtl" : "ltr",
                      options: _vm.ReportigRoleOptions,
                      reduce: function (val) {
                        return val.value
                      },
                      clearable: true,
                    ...
                    on: {
                      input: function ($event) {
                        return _vm.RemoveError("reporting_role")
                      },
                    },
                    model: {
                      value: _vm.Roledata.reporting_role,
                      callback: function ($$v) {
                        _vm.$set(_vm.Roledata, "reporting_role", $$v)
                      },
                      expression: "Roledata.reporting_role",
                    },
                  }),
                  _vm._v(" "),
                  _c("small", { staticClass: "text-danger" }, [
                  ...
                  _vm.hasErrors("reporting_role")
                    ? _c("div", { staticClass: "text-danger" }, [
                        _vm._v(
                          "\n          " +
                            _vm._s(_vm.getErrors("reporting_role")) +
                            "\n        "
                        ),
                      ])
                    : _vm._e(),
              ...
              _c(
                ...
                [
                  _c(
                    "b-form-checkbox",
                    {
                      attrs: { value: _vm.Roledata.master_page, checked: "1" },
                    },
              ...
              _c(
                ...
                [
                  _c("b-table", {
                    attrs: {
                      items: _vm.Roledata.masterFields,
                      fields: ["title", "type", "required", "action"],
                    },
                    scopedSlots: _vm._u([
                      {
                        key: "cell(title)",
