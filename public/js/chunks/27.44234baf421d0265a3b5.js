...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteleaveType: function deleteleaveType() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"]["delete"]("deleteModule/".concat(this.$route.name, "/").concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getModuleData/".concat(route.value.name), {
        params: {
    ...
    var resetBUFilter = function resetBUFilter() {
      SearchFilter.value = [];
      FilterFields.value.forEach(function (item) {
        // Set the value to null or to its default value
        item.value = null; // or set it to the default value you want
      });
      refetchData();
    };
    ...
    var totalBUs = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(0);
    ...
    var FetchTableFilds = function FetchTableFilds() {
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getListingFields/".concat(route.value.name)).then(function (response) {
        fields.value = response.data.data;
      });
    };

    var FilterFields = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);

    var fethFilterFields = function fethFilterFields() {
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getFields/".concat(route.value.name), {
        params: {
          filter: true
        }
      }).then(function (response) {
    ...
    var BUListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(null);
    var perPageOptions = [5, 10, 15];
    var FilterData = {};
    var SearchFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);

    var ResetFilter = function ResetFilter() {
      employeeFilterData.value = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(JSON.parse(JSON.stringify({
    ...
    var showBUModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(false);
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["watch"])([currentPage, perPage, route], function () {
      FetchTableFilds();
      refetchData();
    });
    return {
