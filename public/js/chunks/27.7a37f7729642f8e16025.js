...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    EditIcon: vue_feather_icons__WEBPACK_IMPORTED_MODULE_13__["EditIcon"],
  ...
  methods: {
    ...
    deleteleaveType: function deleteleaveType() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_9__["default"]["delete"]("deleteModule/".concat(this.$route.name, "/").concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
  ...
  setup: function setup(props, _ref) {
    ...
    var _ref2 = [Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(null), Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(false)],
        sortBy = _ref2[0],
        isSortDirDesc = _ref2[1];

    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      FilterFields.value.forEach(function (item) {
        console.log("data", item);
        SearchFilter.value.push({
          'field': item.slug,
          'value': item.value
        }); // You can perform any logic or operations here
      });
      _axios__WEBPACK_IMPORTED_MODULE_9__["default"].get("getModuleData/".concat(route.value.name), {
    ...
    var totalBUs = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(0);
    ...
    var FetchTableFilds = function FetchTableFilds() {
      _axios__WEBPACK_IMPORTED_MODULE_9__["default"].get("getListingFields/".concat(route.value.name)).then(function (response) {
        fields.value = response.data.data;
      });
    };

    var FilterFields = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])([]);

    var fethFilterFields = function fethFilterFields() {
      _axios__WEBPACK_IMPORTED_MODULE_9__["default"].get("getFields/".concat(route.value.name), {
        params: {
          filter: true
        }
      }).then(function (response) {
    ...
    var BUListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(null);
    var perPageOptions = [5, 10, 15];
    var FilterData = {};
    var SearchFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])([]);

    var ResetFilter = function ResetFilter() {
      employeeFilterData.value = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(JSON.parse(JSON.stringify({
    ...
    var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(10);
    ...
    var showBUModal = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["ref"])(false);
    var dataMeta = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["computed"])(function () {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_10__["watch"])([currentPage, perPage, route], function () {
      FetchTableFilds();
      refetchData();
    });
    return {
