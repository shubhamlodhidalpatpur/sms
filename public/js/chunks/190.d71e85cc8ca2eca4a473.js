...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    Onshown: function Onshown() {
      ...
      console.log("this.EditdepartmentId", this.EditdepartmentId, this.AssignSubjectData);
  ...
  setup: function setup(props, _ref) {
    ...
    var submitdepartment = function submitdepartment() {
      console.log("AssignSubjectData", AssignSubjectData.value);
      ...
      if (AssignSubjectData.value.id != null) {
        ...
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("adddepartment", AssignSubjectData.value).then(function () {
          refetchData();
