...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    Onshown: function Onshown() {
      ...
      if (this.RoleEdit != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/roleEdit/".concat(this.RoleEdit)).then(function (response) {
          ...
          _this3.Roledata.roleFields = response.data.data.roleFields;
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var roleFields = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])([]);
    ...
    var showRoleModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(false);
