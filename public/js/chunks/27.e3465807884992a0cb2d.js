  ...
  setup: function setup(props, _ref) {
    ...
    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      FilterFields.value.forEach(function (item) {
        console.log("data", item); // You can perform any logic or operations here
      });
    ...
    var SearchFilter = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_9__["ref"])(JSON.parse(JSON.stringify({
