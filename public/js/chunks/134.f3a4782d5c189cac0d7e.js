    ...
    SectionOnshown: function SectionOnshown() {
      ...
      if (this.EditSectionId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("class/".concat(this.EditSectionId, "/edit")).then(function (response) {
          _this3.SectionData.name = response.data.data.name;
          _this3.SectionData.id = response.data.data.id;
          _this3.SectionData["class"] = response.data.data.parent_id;
        });
      } else {
                              ...
                              ? _c(
                                  ...
                                  [
                                    _c("b-form-checkbox", {
                                      ...
                                      attrs: { plain: "" },
                                      on: { change: data.toggleDetails },
                                      model: {
                                        value: data.detailsShowing,
                                        callback: function ($$v) {
                                          _vm.$set(data, "detailsShowing", $$v)
                                        },
                                        expression: "data.detailsShowing",
                                      },
                                    }),
                                  ],
                                  1
                        ...
                        fn: function (data) {
                          return [
                            _c("span", { staticClass: "text-nowrap" }, [
                              _vm._v(
                                "\n              " +
                                  _vm._s(data.item.children_count) +
                                  "\n            "
                              ),
                            ]),
                          ]
