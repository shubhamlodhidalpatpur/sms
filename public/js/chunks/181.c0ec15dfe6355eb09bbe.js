...
/* harmony default export */ __webpack_exports__["default"] = (_components$directive = {
  ...
  var formSubmitted = function formSubmitted() {
    _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("swapRequest", LeaveTypeData.value).then(function (response) {
      toast({
                            ...
                            fn: function (ref) {
                              ...
                              return [
                                _c("b-form-input", {
                                  ...
                                  model: {
                                    value:
                                      _vm.LeaveTypeData.max_allotment_count,
                                    callback: function ($$v) {
                                      _vm.$set(
                                        _vm.LeaveTypeData,
                                        "max_allotment_count",
                                ...
                                _vm.hasErrors("max_allotment_count")
                                  ? _c("div", { staticClass: "text-danger" }, [
                                      _vm._v(
                                        "\n              " +
                                          _vm._s(
                                            _vm.getErrors("max_allotment_count")
                                          ) +
                                          "\n            "
                                      ),
                                    ])
