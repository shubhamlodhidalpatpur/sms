...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var fetchEmployeesList = function fetchEmployeesList(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_10__["default"].get("employees", {
        params: {
        ...
        totalEmployees.value = fetchEmployeesList[0] != null ? fetchEmployeesList[0].total_row_count : 0; // callback(EmployeesListTableData.value);
      });
    };
                  ...
                  _c("b-table", {
                    ...
                    scopedSlots: _vm._u(
                      [
                        ...
                        _vm._l(
                          _vm.EmployeesTableColumn,
                          function (field, index) {
                            return {
                              key: "cell(" + field.label + ")",
                              fn: function (ref) {
                                var item = ref.item
                                return [
                                  _c(
                                    "div",
                                    { key: index, staticClass: "text-nowrap" },
                                    [
                                      _c(
                                        "span",
                                        {
                                    ...
                                    "b-link",
                                    {
                                      attrs: {
                                        ...
                                        to: {
                                          ...
                                          params: {
                                            id: _vm.encodeBase64(data.item.id),
                                          },
                                        },
                                      },
                                    },
