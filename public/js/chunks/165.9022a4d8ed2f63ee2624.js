...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  }, Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "saveActiveTab", function saveActiveTab() {
    localStorage.setItem("activeTab", this.activeTab);
  }), Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "addLectureRow", function addLectureRow() {
    var newLecture = {
      startTime: "",
      endTime: ""
    };
    this.lectureSchedule.LectureItems.push(newLecture);
  }), Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "removeItem", function removeItem(index) {
    this.lectureSchedule.LectureItems.splice(index, 1);
  }), Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_0__["default"])(_methods, "formSubmitted", function formSubmitted() {
    var _this = this;
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("getClassSection").then(function (response) {
      _this2.ClassOptionData = response.data.data;
      _this2.lectureSchedule["class"] = _this2.$route.params.id;
    });
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("getLectureData/".concat(this.$route.params.id)).then(function (response) {
      _this2.lectureSchedule.LectureItems = response.data.data.lecture_data;
    });
  },
                        ...
                        [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _vm._l(_vm.lacture, function (lac) {
