...
/* harmony import */ var _components_button_Button_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../components/button/Button.vue */ "./resources/js/src/views/components/button/Button.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    Button: _components_button_Button_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_5__["default"].login({
            ...
            _this.$ability.update(userData.ability); // this.$router
