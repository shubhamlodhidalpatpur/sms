...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/logo/bizinso-icon.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony import */ var _components_button_Button_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../components/button/Button.vue */ "./resources/js/src/views/components/button/Button.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    VuexyLogo: !(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/logo/bizinso-icon.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
    ...
    Button: _components_button_Button_vue__WEBPACK_IMPORTED_MODULE_15__["default"]
  },
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_9__["default"].login({
            ...
            _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_13__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
              _this.$toast({
