...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('getBUData').then(function (response) {
      _this.BUData = response.data.department;
      _this.branchMemberData = response.data.branchMember;
    });
  },
  methods: {
    ...
    deletebranch: function deletebranch() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"]["delete"]("branch/".concat(this.DeleteId)).then(function (response) {
        _this2.refetchData();
    ...
    Onshown: function Onshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('repotingManager').then(function (response) {
        // this.repotingManager = response.data.employee
        _this3.BUData = response.data.department; // this.branchMemberData=response.data.branchMember
      });
      console.log("this.EditbranchId", this.EditbranchId, this.branchData);

      if (this.EditbranchId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("branchedit/".concat(this.EditbranchId)).then(function (response) {
          _this3.branchData.branch_name = response.data.data.title;
          _this3.branchData.id = response.data.data.id; // this.branchData.reporting_manager = response.data.data.reporting_manage

          _this3.branchData.Department = response.data.data.department_id; // this.branchData.branch_members = response.data.data.branch_members
        });
      } else {
        this.branchData.branch_name = '';
        this.branchData.id = null; // this.branchData.reporting_manager = ''

        this.branchData.Department = ''; // this.branchData.branch_members = ''
      }
    },
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchbranch = function fetchbranch(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('fetchbranch', {
        ...
        var branch = response.data.data; // console.log("fetchUser response",task, total,response.data)
    ...
    var submitbranch = function submitbranch() {
      ...
      if (branchData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post("branchUpdate/".concat(branchData.value.id), branchData.value).then(function () {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].post('addbranch', branchData.value).then(function () {
          refetchData();
    ...
    var showbranchModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(false);

    var RemoveError = function RemoveError(errorName) {
      errors.value[errorName] = " ";
    };

    var branchData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(JSON.parse(JSON.stringify(blankbranchData)));
    var refbranchListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(null);
    ...
    var branchFilterData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_5__["ref"])(JSON.parse(JSON.stringify({
                                        ...
                                        [
                                          _c("b-form-input", {
                                            ...
                                            model: {
                                              ...
                                              callback: function ($$v) {
                                                _vm.$set(
                                                  _vm.branchFilterData,
                                                  "name",
                                                  $$v
                                                )
                                              },
                                              expression:
                                                "branchFilterData.name",
                                            },
                                          }),
                                        ],
                                        1
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c("v-select", {
                                            ...
                                            model: {
                                              value:
                                                _vm.branchFilterData.Department,
                                              callback: function ($$v) {
                                                _vm.$set(
                                                  _vm.branchFilterData,
                                                  "Department",
          ...
          _c(
            ...
            [
              ...
              _c("v-select", {
                ...
                model: {
                  value: _vm.branchData.Department,
                  callback: function ($$v) {
                    _vm.$set(_vm.branchData, "Department", $$v)
                  },
                  expression: "branchData.Department",
                },
              }),
              _vm._v(" "),
            ...
            [
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("b-form-input", {
                    attrs: { id: "branch Name", placeholder: "branch Name" },
                    on: {
                      input: function ($event) {
