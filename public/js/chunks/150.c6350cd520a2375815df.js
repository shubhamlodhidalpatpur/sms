...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteholiday: function deleteholiday() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"]["delete"]("holidays/".concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
    ...
    Onshown: function Onshown() {
      ...
      if (this.EditClassId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("holidays/".concat(this.EditClassId, "/edit")).then(function (response) {
          _this2.ClassData.name = response.data.data.holiday_name;
    ...
    SectionOnshown: function SectionOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getClass").then(function (response) {
        _this3.ClassOptionsData = response.data["class"];
      });

      if (this.EditSectionId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("holidays/".concat(this.EditClassId, "/edit")).then(function (response) {
          _this3.ClassData.name = response.data.data.holiday_name;
          _this3.ClassData.id = response.data.data.id;
        });
      } else {
        this.ClassData.name = "";
        this.ClassData.id = null;
  ...
  setup: function setup(props, _ref) {
    ...
    var SubmitClass = function SubmitClass() {
      if (ClassData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].put("ClassUpdate/".concat(ClassData.value.id), ClassData.value).then(function () {
          refetchData();
    ...
    var SubmitSection = function SubmitSection() {
      if (SectionData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].put("ClassUpdate/".concat(SectionData.value.id), SectionData.value).then(function () {
          refetchData();
    ...
    var ShowGroupModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(false);
    ...
    var GroupData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify(blankGroupData)));
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          attrs: {
            visible: _vm.ShowGroupModel,
            title: _vm.EditGroupId ? "Update Group" : "Add Group",
            "ok-title": _vm.EditGroupId ? "Update" : "Add",
            centered: "",
            "cancel-variant": "outline-secondary",
          },
          on: {
            ok: _vm.GrouphandleOk,
            show: _vm.GroupOnshown,
            hidden: _vm.resetModal,
          },
        },
        [
              ...
              _c(
                ...
                [
                  ...
                  _c("v-select", {
                    ...
                    model: {
                      value: _vm.GroupData.class,
                      callback: function ($$v) {
                        _vm.$set(_vm.GroupData, "class", $$v)
                      },
                      expression: "GroupData.class",
                    },
                  }),
                  _vm._v(" "),
                  _c("small", { staticClass: "text-danger" }, [
