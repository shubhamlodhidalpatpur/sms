...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BProgressBar: bootstrap_vue__WEBPACK_IMPORTED_MODULE_4__["BProgressBar"],
  ...
  data: function data() {
    return {
      ...
      tableData: [{
        ...
        day: 'Timing',
        lecture1: '11:00-12:00',
        lecture2: '11:00-12:00',
        lecture3: '11:00-12:00',
        lecture4: '11:00-12:00',
        lecture5: '11:00-12:00',
        lecture6: '11:00-12:00',
        lecture7: '11:00-12:00'
      }, {
        day: 'M',
        lecture1: 'Physics - AK sir',
        lecture2: 'Chemistry - AK sir',
        lecture3: 'Physics - AK sir',
        lecture4: 'Chemistry - AK sir',
        lecture5: 'Physics - AK sir',
        lecture6: 'Chemistry - AK sir',
        lecture7: 'Physics - AK sir'
      }, {
        day: 'T',
        lecture1: '',
        lecture2: '',
  ...
  methods: {
    ...
    formSubmitted: function formSubmitted() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_5__["default"].post('updateClassLacture', this.lectureSchedule).then(function (response) {
        _this.$toast({
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_5__["default"].get("getClassSection").then(function (response) {
      _this2.ClassOptionData = response.data.data;
      _this2.lectureSchedule["class"] = _this2.$route.params.id;
    });
    _axios__WEBPACK_IMPORTED_MODULE_5__["default"].get("getLectureData/".concat(this.$route.params.id)).then(function (response) {
  ...
  setup: function setup(props, _ref) {
    ...
    var lectureSchedule = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(JSON.parse(JSON.stringify(blanklectureSchedule)));
    return {
        ...
        [
          ...
          _c(
            ...
            [
              _vm._v(" "),
              _c("b-table", {
                attrs: { items: _vm.tableData, fields: _vm.tableField },
              }),
            ],
            1
          ),
