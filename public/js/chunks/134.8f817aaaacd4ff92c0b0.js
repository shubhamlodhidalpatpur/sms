  ...
  methods: {
    ...
    AssignTeacherOnshown: function AssignTeacherOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_9__["default"].get("getSubjectsWithTeacher/".concat(this.AssignClassId)).then(function (response) {
        ...
        response.data.data.forEach(function (subject, index) {
          _this4.AssignTeacherData.SubjctTeacherData[index].subject_id = subject;
          _this4.AssignTeacherData.SubjctTeacherData[index].subject_teacher_id = null;
        });
      });
    },
