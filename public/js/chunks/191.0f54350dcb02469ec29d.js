    ...
    Onshown: function Onshown() {
      ...
      if (this.MasterEdit != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/master/".concat(this.MasterEdit, "/edit")).then(function (response) {
          _this3.MasterData.name = response.data.data.name;
          _this3.MasterData.department = response.data.data.department_id;
          _this3.MasterData.reporting_role = response.data.data.parent_id;
          _this3.MasterData.team = response.data.data.team;
