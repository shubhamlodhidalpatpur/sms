...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    var NavMenuItem = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])([]);
    ...
    _axios__WEBPACK_IMPORTED_MODULE_11__["default"].get("master").then(function (response) {
      NavMenuItem.value = response.data;
    });
      ...
      !_vm.isNavMenuHidden
        ? _c("vertical-nav-menu", {
            attrs: {
              ...
              "toggle-vertical-menu-active": _vm.toggleVerticalMenuActive,
              "nav-menu-items": _vm.NavMenuItem,
            },
            scopedSlots: _vm._u(
              [
                {
