    ...
    Onshown: function Onshown() {
      ...
      if (this.EditdepartmentId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("departmentedit/".concat(this.EditdepartmentId)).then(function (response) {
          _this3.AssignSubjectData.department_name = response.data.data.title;
          _this3.AssignSubjectData.id = response.data.data.id;
          _this3.AssignSubjectData.branch = response.data.data.branch_id;
        });
      } else {
        this.AssignSubjectData.department_name = "";
        this.AssignSubjectData.id = null;
        this.AssignSubjectData.branch = "";
      }
    },
