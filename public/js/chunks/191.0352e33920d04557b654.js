...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    addLectureRow: function addLectureRow() {
      var newLecture = {
        lectureNo: this.lectureSchedule.length + 1,
        startTime: '',
        endTime: ''
      };
      this.lectureSchedule.push(newLecture);
    },
    removeItem: function removeItem(index) {
      this.lectureSchedule.splice(index, 1);
    },
  ...
  mounted: function mounted() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_6__["default"].get("getClassSection").then(function (response) {
      ...
      _this.AssignSubjectData["class"] = _this.AssignClassId;
    });
  },
  setup: function setup(props, _ref) {
    ...
    var AssignTeacherData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(JSON.parse(JSON.stringify(blankAssignTeacherData)));
    return {
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("b-card-title", [_vm._v("12 Class Time Table ")]),
      _vm._v(" "),
      _c(
        "b-tabs",
        {
