...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteholiday: function deleteholiday() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("deleteClassSection/".concat(this.DeleteId)).then(function (response) {
        _this.refetchData();
    ...
    Onshown: function Onshown() {
      ...
      if (this.EditClassId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("class/".concat(this.EditClassId, "/edit")).then(function (response) {
    ...
    AssignSubjectOnshown: function AssignSubjectOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getClassSection").then(function (response) {
        _this3.ClassOptionData = response.data.data;
        _this3.AssignSubjectData["class"] = _this3.AssignClassId;
      });
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getSubject").then(function (response) {
        _this3.SubjectData = response.data.data;
      });
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getSubjects/".concat(this.AssignClassId)).then(function (response) {
    ...
    AssignTeacherOnshown: function AssignTeacherOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("users").then(function (response) {
        _this4.TeacherData = response.data.table_data;
      });
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getSubject").then(function (response) {
        _this4.SubjectData = response.data.data;
      });
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getSubjectDataOfClass/".concat(this.AssignTeacherData["class"])).then(function (response) {
        _this4.SubjectData = response.data.data;
      });
    },
    SectionOnshown: function SectionOnshown() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getClass").then(function (response) {
        _this5.ClassOptionsData = response.data["class"];
      });

      if (this.EditSectionId != 0) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("class/".concat(this.EditSectionId, "/edit")).then(function (response) {
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchClassSection = function fetchClassSection(ctx, callback) {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("ClassSections", {
    ...
    var SubmitClass = function SubmitClass() {
      if (ClassData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("ClassUpdate/".concat(ClassData.value.id), ClassData.value).then(function () {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("ClassStore", ClassData.value).then(function () {
          refetchData();
    ...
    var SubmitSection = function SubmitSection() {
      if (SectionData.value.id != null) {
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("SectionUpdate/".concat(SectionData.value.id), SectionData.value).then(function () {
          refetchData();
        ...
        _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("SectionStore", SectionData.value).then(function () {
          refetchData();
          emit("removeBlankholidayError");
          ShowSectionModel.value = false;
          toast({
    ...
    var SubmitAssignSubject = function SubmitAssignSubject() {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("AssignSubject", AssignSubjectData.value).then(function () {
        refetchData();
    ...
    var SubmitAssignTeacher = function SubmitAssignTeacher() {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post("AssignTeacher", AssignSubjectData.value).then(function () {
        refetchData();
        showAssignSubjectModel.value = false;
        toast({
          component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    ...
    var AssignSubjectData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify(blankAssignSubjectData)));
    var AssignTeacherData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify(blankAssignTeacherData)));
    var errors = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])([]);
    var ShowClassModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(false);
    var ShowSectionModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(false);
    var showAssignSubjectModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(false);
    var showAssignTeacherModel = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(false);

    var RemoveError = function RemoveError(errorName) {
      errors.value[errorName] = " ";
    };

    var ClassData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify(blankClassData)));
    var SectionData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify(blankSectionData)));
    var refholidayListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(null);
    ...
    var holidayFilterData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_6__["ref"])(JSON.parse(JSON.stringify({
