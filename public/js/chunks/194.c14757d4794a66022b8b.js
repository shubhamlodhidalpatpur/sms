...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var fetchLeaveType = function fetchLeaveType(ctx, callback) {
      console.log('FilterFields.value', FilterFields.value);
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getModuleData/".concat(route.value.name), {
        params: Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(_home_shuhbham_wokspace_sms_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, FilterFields.value), {}, {
    ...
    var fethFilterFields = function fethFilterFields() {
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get("getFields/".concat(route.value.name), {
        params: {
          filter: true
        }
      }).then(function (response) {
