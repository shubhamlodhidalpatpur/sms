      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].login({
            ...
            console.log("dvhbhgcs");
            console.log("response", response.data);
            console.log("ability", response.data.userData.ability);
            _this.showAlert = true;
            var userData = response.data.userData;
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].setToken(response.data.accessToken);
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].setRefreshToken(response.data.refreshToken);
