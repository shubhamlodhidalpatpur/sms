...
/* harmony import */ var _ForgotPassword_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ForgotPassword.vue */ "./resources/js/src/views/pages/authentication/ForgotPassword.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    ForgotPassword: _ForgotPassword_vue__WEBPACK_IMPORTED_MODULE_13__["default"]
  },
  ...
  data: function data() {
    return {
      ...
      sideImg: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/pages/login.jpg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
      showAlert: false,
      // validation rules
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      if (_store_index__WEBPACK_IMPORTED_MODULE_11__["default"].state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/pages/login.jpg'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
        return this.sideImg;
      }
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_8__["default"].login({
            ...
            // this.showAlert = true;
            var userData = response.data.userData; // useJwt.setRefreshToke  n(response.data.refreshToken)

            if (userData.ability.length != 0) {
              ...
              _this.$router.replace(Object(_auth_utils__WEBPACK_IMPORTED_MODULE_12__["getHomeRouteForLoggedInUser"])(userData.role)).then(function () {
                _this.$toast({
                  ...
                  position: 'top-right',
                  props: {
                    title: "Welcome ".concat(userData.name || userData.user_name),
                    icon: 'CoffeeIcon',
              ...
              _this.$toast({
                ...
                position: 'top-right',
                props: {
                  title: "You are not Authorized to Login,Please Contact Admin..",
                  icon: 'CoffeeIcon',
                  variant: 'danger'
                }
              });
...
var render = function () {
  ...
  return _c("div", { staticClass: "auth-wrapper auth-v2 loginBase" }, [
    _c(
      "div",
      { staticClass: "auth-inner m-0" },
      [
        _c("b-link", { staticClass: "brandLogo" }, [
          _c("img", {
            staticClass: "imgOne",
            attrs: {
              src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/logo/bizinso-icon-white.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
            },
          }),
          _vm._v(" "),
          _c("img", {
            staticClass: "imgTwo",
            attrs: {
              src: __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/assets/images/logo/bizinso-logo-white.png'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
            },
          }),
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "loginBox" }, [
          _c(
            "div",
            { staticClass: "d-flex align-items-center bg-white  w-50" },
            [
              _c(
                "div",
                {
                  staticClass:
                    "w-100 d-lg-flex align-items-center justify-content-center authImage",
                },
                [
                  _c("b-img", {
          ...
          _c(
            ...
            {
              staticClass:
                "d-flex align-items-center auth-bg px-md-2 bg-white w-50",
            },
            [
              _c(
                "div",
                { staticClass: "mx-auto w-100 px-3" },
                [
                  _c(
                    "b-card-title",
                    {
                  ...
                  _c(
                    "b-alert",
                    { attrs: { variant: "primary", show: _vm.showAlert } },
                    [
