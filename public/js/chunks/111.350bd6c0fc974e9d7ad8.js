...
/* harmony default export */ __webpack_exports__["default"] = (_components$directive = {
  ...
  var fetchModuleForm = function fetchModuleForm() {
    _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("getFields/".concat(route.value.params.module_name)).then(function (response) {
  ...
  var submit = function submit() {
    ...
    _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post("SubmitModule/".concat(route.value.params.module_name), formData, {
      headers: {
